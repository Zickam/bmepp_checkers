...
class SimpleGame:
    def __init__(self):
        ...
        self._board[3, 0] = np.array([True, False, False])
        self._board[3, 4] = np.array([True, False, False])
        self._board[4, 3] = np.array([1, 0, 1])
        self._board[7, 0] = np.array([1, 1, 0])
        self._board[1, 6] = np.array([1, 1, 0])
        #
        ...
        # self._board[4, 1] = np.array([1, 1, 0])
        # self._board[5, 2] = np.array([1, 1, 0])
        # self._board[5, 0] = np.array([1, 1, 0])
        # self._board[4, 3] = np.array([1, 0, 0])
